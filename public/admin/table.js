$(document).ready(function () {
    ...
    function drawTable(arr) {
        ...
        $.each(arr, function () {
            ...
            user_data += '<a href=""><span class="lv-data-table-icon fas fa-edit lv-data-table-edit" ></span></a>';
            user_data += '<a href=""><span class="lv-data-table-icon far fa-trash-alt lv-data-table-trash" data-delete="' + this.id + '"></span></a>';
            user_data += '</td>';
    ...
    $('#createNewUser').on('click', function (e) {
        $.get("/admin/management/users/create", function (data) {
            let roles = data.role;
    ...
    //edit
    $(document).on('click','.lv-data-table-edit' , function (e) {
        e.preventDefault();
        let id = $(this).parents('tr').find('.id-column').data('id');
        $.get("/admin/management/users/" + id + '/edit', function (data) {
            let roles = data.role;
            let user = data.user;
